...
public static class SpriteUtil
{
    ...
    /// <returns>载入后的 Sprite</returns>
    public static Sprite fromFile(string filename, FilterMode filterMode)
    {
    ...
    /// <summary>
    /// 从文件载入 Sprite，默认使用 FilterMode.Point
    /// </summary>
    /// <param name="filename">文件名</param>
    /// <returns>载入后的 Sprite</returns>
    public static Sprite fromFile(string filename)
    {
        return fromFile(filename, FilterMode.Point); //不过滤，适合像素风
    }
