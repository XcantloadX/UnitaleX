    ...
    private void HandleArrows()
    {
        ...
        switch (state)
        {
            case UIState.ACTIONSELECT:
                ...
                if (right)
                    actionIndex++;
                actionIndex = UnitaleMath.mod(actionIndex, 4);
            ...
            case UIState.ACTMENU:
                ...
                if (left || right)
                    xCol = UnitaleMath.mod(xCol, 2);
                if (up || down)
                    yCol = xCol == 0 ? UnitaleMath.mod(yCol, leftColSize) : UnitaleMath.mod(yCol, rightColSize);
            ...
            case UIState.ITEMMENU:
                ...
                int xColI = UnitaleMath.mod(selectedItem, 2);
                int yColI = UnitaleMath.mod(selectedItem, 4) / 2;
                ...
                if (up || down)
                    yColI = xColI == 0 ? UnitaleMath.mod(yColI, leftColSizeI) : UnitaleMath.mod(yColI, rightColSizeI);
            ...
            case UIState.MERCYMENU:
                ...
                if (encounter.CanRun)
                {
                    selectedMercy = UnitaleMath.mod(selectedMercy, 2);
                }
                else
                {
                    selectedMercy = 0;
